...
<head>
    ...
    <link rel="stylesheet" href="appbetganarace/assets/css/animate.css">
    <link rel="stylesheet" href="appbetganarace/assets/css/icofont.min.css">
    <link rel="stylesheet" href="appbetganarace/assets/css/swiper-bundle.min.css">
    <link rel="stylesheet" href="appbetganarace/assets/css/style.css">
</head>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('/betgana')}}">Betgana</a>
                            </li>
...
@yield('content')
    ...
    <script src="appbetganarace/assets/js/jquery.js"></script>
    <script src="appbetganarace/assets/js/jquery-migrate-1.2.1.min.js"></script>
    <script src="appbetganarace/assets/js/fontawesome.min.js"></script>
    <script src="appbetganarace/assets/js/bootstrap.bundle.min.js"></script>
    <script src="appbetganarace/assets/js/isotope.pkgd.min.js"></script>
    <script src="appbetganarace/assets/js/counterup.js"></script>
    <script src="appbetganarace/assets/js/swiper-bundle.min.js"></script>
    <script src="appbetganarace/assets/js/wow.min.js"></script>
    <script src="appbetganarace/assets/js/main.js"></script>
    <script src="/assets/js/form-betganarace.js"></script>
</body>
