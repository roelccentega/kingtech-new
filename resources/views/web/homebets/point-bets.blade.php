...
NEGOCIO</h5>
                        ...
                        <p>Inicia con un punto de venta de apuestas en el rubro más rentable del mercado y obtén mayores ingresos para tu negocio.</p>
            ...
            <div class="row justify-content-center align-items-center flex-row-reverse g-4">
                <div class="col-lg-6 col-12 wow fadeInUp" data-wow-delay=".5s">
                    <div class="about__content">
                        ...
                        <ul>
                            <li>
                                <h5 class="titlre"><i class="fa-solid fa-check"></i> Espacio habilitado dentro de tu negocio</p>
                            </li>
                            <li>
